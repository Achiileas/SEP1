...
public class MyFileHandler
{
  ...
  public static void saveModel(ClovervilleModel model, String filename) {
  ...
  public static ClovervilleModel loadModel(String filename) {
    try (FileReader reader = new FileReader(filename)) {
      Gson gson = new Gson();
      ClovervilleModel model = gson.fromJson(reader, ClovervilleModel.class);
      System.out.println("Loaded model from " + filename);
      return model;
    } catch (Exception e) {
      System.out.println("Could not load " + filename + ", creating default model.");
      return null;
    }
  }
